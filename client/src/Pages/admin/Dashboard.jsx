...
const {axios}= useAppContext();
  const fetchDashboard = async () => {
    try {
      ...
      data.sucess?setDashboard(data.dashboardData) :toast.error(data.message);
    } catch (error) {
    ...
    <div className='flex-1  p-4 md:p-10 bg-amber-100/100 '>
      ...
      <div className='mt-8'>
        <div className='flex  items-center  '>
          <img src={assets.dashboard_icon_4} alt="" /><p className='ml-2'>Latest Blogs</p>
        </div>


        <div className='relative max-w-4xl overflow-x-auto shadow rounded-lg scrollbar-hide bg-white mt-5'>
